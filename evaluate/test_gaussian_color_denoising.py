...
if args.result_dir is None:
    args.result_dir = f'./results/SFUNet_color_dn_sigma{sigma}/'
...
if sigma == 15:
    weights = 'experiments/GaussianColorDenoising_SFUNet_Sigma15/models/net_g_400000.pth'
elif sigma == 25:
    weights = 'experiments/GaussianColorDenoising_SFUNet_Sigma25/models/net_g_400000.pth'
else:
    weights = 'experiments/GaussianColorDenoising_SFUNet_Sigma50/models/net_g_400000.pth'
...
for dataset in datasets:
    ...
    with torch.no_grad():
        for file_ in tqdm(files):
            ...
            utils.save_img(noisy_save_file, img_as_ubyte(np.clip(img, 0, 1)))
