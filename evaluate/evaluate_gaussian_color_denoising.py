...
parser = argparse.ArgumentParser(description='Gasussian Color Denoising')
...
for dataset in datasets:
    ...
    for sigma_test in sigmas:
        file_path = os.path.join('results', 'SFUNet_color_dn_sigma' + str(sigma_test), dataset, str(sigma_test))
